...
@transform(
    output_df=Output("ri.foundry.main.dataset.3ecd86ea-ef5d-4944-b77d-e78ac10cd33d"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.107a1f8d-dcf9-44b9-842a-c17e2ac5846b"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[11])
