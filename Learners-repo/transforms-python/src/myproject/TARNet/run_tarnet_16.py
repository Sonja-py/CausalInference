...
@transform(
    output_df=Output("ri.foundry.main.dataset.02565d66-6582-40ef-b528-c2f3d2f4925f"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.b4ba2539-57f0-41dc-9e81-bb756ea117c1"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    ingredient_pairs = [(44507700, 797617), (44507700, 778268), (44507700, 40234834)]
    ...
    results_df, counterfactual_df = tarnet_func(source_df, ingredient_pairs)
