...
@transform(
    output_df=Output("ri.foundry.main.dataset.b907dc36-269c-4e95-8f4b-f323e74bc10d"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.f51c228d-0eff-4a16-bbe7-73667d3dcf3d"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[2])
