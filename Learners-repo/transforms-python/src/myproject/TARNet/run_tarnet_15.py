...
@transform(
    output_df=Output("/UNITE/[RP-1225E6] Effects of drugs on COVID-19 trajectory/Anugrah Analysis/workbook-output/TARNet/ds15"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.516640b3-b625-4890-8176-2bb39015bbab"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[14])
