...
@transform(
    output_df=Output(
        "/UNITE/[RP-1225E6] Effects of drugs on COVID-19 trajectory/Anugrah Analysis/workbook-output/TARNet/confidence_interval_2"
    ),
...
def compute(output_df, source_df, hyperparams_df):
    ...
    results_df = bootstrap_func(source_df, hyperparams_df, mini_batches[1])
