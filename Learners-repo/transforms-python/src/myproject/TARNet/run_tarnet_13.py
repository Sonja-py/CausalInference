...
@transform(
    output_df=Output("ri.foundry.main.dataset.215d2abd-b58b-417a-8793-6724b4771e8b"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.284c3417-ed32-44b1-99e7-4acb58c67e64"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[12])
