...
@transform(
    output_df=Output("ri.foundry.main.dataset.d1cf32b4-3cfe-4ec9-aca6-740a12b0e8b2"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.ccaefad2-e2b6-47cb-af94-8e0ebdaa7764"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[3])
