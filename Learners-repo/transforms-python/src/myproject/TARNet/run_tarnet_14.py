...
@transform(
    output_df=Output("/UNITE/[RP-1225E6] Effects of drugs on COVID-19 trajectory/Anugrah Analysis/workbook-output/TARNet/ds14"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.94d48e6b-6167-4fec-848d-f8959be05377"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[13])
