...
@transform(
    output_df=Output("ri.foundry.main.dataset.d5f39f62-9227-48bc-abab-116dd81d0f88"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.9679423a-935b-401d-b8ad-5e00730aee98"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[8])
