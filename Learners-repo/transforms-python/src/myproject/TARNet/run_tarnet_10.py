...
@transform(
    output_df=Output("ri.foundry.main.dataset.2330f61a-cce3-4046-9ba1-715c4d341350"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.69973670-1d70-4ce6-8f05-561c4bb57711"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[9])
