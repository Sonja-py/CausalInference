...
@transform(
    output_df=Output("ri.foundry.main.dataset.a8fa3bc7-d453-4bcc-946c-47a4e0aad9fb"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.b2b7ca5a-46d8-419c-a3f9-bd683a459a6c"),
