...
@transform(
    output_df=Output("ri.foundry.main.dataset.9181fa3b-dc08-4377-8c39-7bedffed6337"),
    output_counterfactual_df=Output("ri.foundry.main.dataset.fb6ca9ef-6512-4949-be48-3f92af572749"),
...
def compute(output_df, output_counterfactual_df, source_df):
    ...
    results_df, counterfactual_df = tarnet_func(source_df, mini_batches[7])
