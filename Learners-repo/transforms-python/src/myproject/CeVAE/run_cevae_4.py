...
@transform(
    output_25=Output("ri.foundry.main.dataset.c291e468-0835-4504-82d1-074cb4a3288a"),
    output_50=Output("ri.foundry.main.dataset.0542d418-99cd-4273-8484-1df7a87c7e60"),
    output_75=Output("ri.foundry.main.dataset.5601bd47-740e-452b-877f-a0bd86b7a733"),
    output_df=Output("ri.foundry.main.dataset.79a84d6a-90b9-4cdd-8ddc-84acec6203ba"),
