...
@transform(
    output_25=Output("ri.foundry.main.dataset.dd27b45d-d6ef-48b0-b557-2fadd918e1f5"),
    output_50=Output("ri.foundry.main.dataset.3a128a4e-49cb-4ac9-95f8-c6cfd0da2b62"),
    output_75=Output("ri.foundry.main.dataset.11c69551-93e4-4fd4-ba03-f4f70f6564c2"),
    output_df=Output("ri.foundry.main.dataset.8535c293-b3d3-45b4-8513-9c4a47fb65fe"),
